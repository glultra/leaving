<div>
    <section class="bg-gray-50 dark:bg-gray-900">
        <a href=" {{ route('home') }} " class="m-3 fixed">
            <svg class="w-9 h-9 ml-5 dark:fill-white" fill="currentColor" viewBox="0 0 20 20"
        ...
        <div class="flex flex-col items-center justify-center px-6 py-6 mx-auto md:h-screen lg:py-0">
            ...
            <div
                ...
                <div class="p-6 space-y-3 md:space-y-6 sm:p-8">
                    <h1
                        class="text-sm  font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                        Create and account
                    </h1>
