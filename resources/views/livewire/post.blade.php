                ...
                <div
                    ...
                    <form wire:submit.prevent='store' class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="body" wire:model='body' cols="30" rows="4" class="bg-slate-200 dark:bg-slate-600 border-2 border-transparent shadow-slate-700 shadow dark:shadow-slate-900
